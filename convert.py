...
json_path = "./Flow 3.json"  # Cập nhật đường dẫn nếu cần
...
# Mở trang trống
driver.get("data:text/html,<html><head><title>Lottie Animation</title></head><body style='background: transparent;'></body></html>")
...
# Inject JSON vào trang và render với nền trong suốt
driver.execute_script('''
...
# Chụp lại từng khung hình với nền trong suốt
...
# Lưu các khung hình thành GIF với nền trong suốt
frames[0].save("output_animation.gif", save_all=True, append_images=frames[1:], duration=int(duration * 1000), loop=0, transparency=0)

print("File GIF đã được lưu thành công với nền trong suốt.")
driver.quit()
